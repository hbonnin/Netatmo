...
function ds_template_main_above(t) {
	...
	return '<table cellpadding="3" cellspacing="1" class="ds_tbl">'
		 ...
		 + '</tr>'
		 + '<tr>'
		 + '<td colspan="7" class="ds_head" style="cursor: pointer" onclick="setDate();">' + txt + '</td>'
		 + '</tr>'
		 + '<tr>'
...
function ds_sh(t,i) {
	...
	//caption
	if(i == 0)
		{document.getElementById('ds_conclass').caption.innerHTML = "D&eacute;but des mesures";
		dateSet = dateend;
		date1 = 0;
		}
	else
...
function setDate() {
    //ds_element.innerHTML = dateSet;
    ds_hi();
	if (typeof(ds_element.value) != 'undefined') {
		// Set the value of it, if we can.
		ds_element.value = dateSet;
	}
...
if(date1 == 1)dateend = ds_format_date(d, m, y);	
}
</script>
